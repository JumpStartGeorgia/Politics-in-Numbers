(function(g) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(j) {
        return g(j, window, document) }) : "object" === typeof exports ? module.exports = function(j, i, q, r) { j || (j = window);
        if (!i || !i.fn.dataTable) i = require("datatables.net")(j, i).$;
        i.fn.dataTable.Buttons || require("datatables.net-buttons")(j, i);
        return g(i, j, j.document, q, r) } : g(jQuery, window, document) })(function(g, j, i, q, r, m) {
    function E(a, b) {
            ...
            if (g.isPlainObject(c)) {
                ...
                if (v) {
                    var e = c.childNodes[0],
                        f, h, n = [];
                    for (f = e.attributes.length - 1; 0 <= f; f--) { h = e.attributes[f].nodeName;
                        var k = e.attributes[f].nodeValue; - 1 !== h.indexOf(":") && (n.push({ name: h, value: k }), e.removeAttribute(h)) }
                    f = 0;
    ...
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) p = void 0;
        ...
        var w = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            ...
            A = 0,
            B = function(a) { setTimeout(function() { typeof a === "string" ? (h.URL || h.webkitURL || h).revokeObjectURL(a) : a.remove() }, 4E4) },
            C = function(a, b, d) {
                for (var b = [].concat(b), c = b.length; c--;) {
                    var e = a["on" + b[c]];
                    if (typeof e === "function") try { e.call(a, d || a) } catch (f) { P(f) } } },
            I = function(a) {
            ...
            J = function(a, b, d) {
                ...
                var c = this,
                    d = a.type,
                    e = false,
                    f, g, n = function() { C(c, ["writestart", "progress", "write", "writeend"]) },
                    k = function() {
                ...
                c.readyState = c.INIT;
                b || (b = "download");
                if (O) { f = (h.URL || h.webkitURL || h).createObjectURL(a);
                    setTimeout(function() { w.href = f;
                        w.download = b;
                        var a = new MouseEvent("click");
                        w.dispatchEvent(a);
                        n();
                        B(f);
                        c.readyState = c.DONE }) } else {
                    if (h.chrome && d && d !== "application/octet-stream") { u = a.slice || a.webkitSlice;
                    ...
                    if (H) {
                        ...
                        H(h.TEMPORARY, A, t(function(d) {
                            d.root.getDirectory("saved", j, t(function(d) {
                                var f = function() { d.getFile(b, j, t(function(b) { b.createWriter(t(function(d) { d.onwriteend = function(a) { g.location.href = b.toURL();
                                                c.readyState = c.DONE;
                                                C(c, "writeend", a);
                                                B(b) };
                                            d.onerror = function() {
                                            ...
                                            c.abort = function() { d.abort();
                                                c.readyState = c.DONE };
                                            c.readyState = c.WRITING }), k) }), k) };
                                d.getFile(b, { create: false }, t(function(a) { a.remove();
                                    f() }), t(function(a) { a.code === a.NOT_FOUND_ERR ? f() : k() }))
                            }), k)
                        }), k)
                    } else k()
                }
            ...
            l = J.prototype;
        "undefined" !== typeof navigator && navigator.msSaveOrOpenBlob ? p = function(a, b, d) { d || (a = I(a));
            return navigator.msSaveOrOpenBlob(a, b || "download") } : (l.abort = function() { this.readyState = this.DONE;
            C(this, "abort") }, l.readyState = l.INIT = 0, l.WRITING = 1, l.DONE = 2, l.error = l.onwritestart = l.onprogress = l.onwrite = l.onabort = l.onerror = l.onwriteend = null, p = function(a, b, d) {
            return new J(a, b, d) })
    }
    s.fileSave =
        p;
    var x = function(a, b) {
        ...
        L = function(a, b) {
            ...
            for (var d = K(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), h = b.escapeChar !== m ? b.escapeChar : "\\", k = function(a) {
                    for (var b = "", c = 0, d = a.length; c < d; c++) { c > 0 && (b = b + f);
                        b = b + (e ? e + ("" + a[c]).replace(g, h + e) + e : a[c]) }
                    return b }, j = b.header ? k(c.header) + d : "", i = b.footer && c.footer ? d + k(c.footer) : "", u = [], D = 0, l = c.body.length; D < l; D++) u.push(k(c.body[D]));
            console.log(b.header ? k(c.header) + d : "", c.header, d);
    ...
    s.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            g(i).on("keydown.buttons-copy", function(a) { a.keyCode === 27 && j() }).on("copy.buttons-copy cut.buttons-copy", function() { j() })
        },
        exportOptions: {},
        fieldSeparator: "\t",
        fieldBoundary: "",
    ...
    s.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            c.customize &&
                (a = c.customize(a, c));
            if (b !== false) { b || (b = i.characterSet || i.charset);
                b && (b = ";charset=" + b) } else b = "";
    ...
    s.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            var e = 0,
                ...
                j, k, d = function(a) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        else { i = !a[b].replace ? a[b] : a[b].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "");
            ...
            if (c.header) { d(b.header, e);
                g("row c", f).attr("s", "2") }
            for (var i = 0, l = b.body.length; i < l; i++) d(b.body[i], e);
            if (c.footer && b.footer) { d(b.footer, e);
            ...
            E(b, a);
            b.generateAsync ? b.generateAsync(d).then(function(a) { p(a, x(c)) }) : p(b.generate(d), x(c))
        },
        filename: "*",
        extension: ".xlsx",
        exportOptions: {},
    ...
    s.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            a = r.createPdf(a);
            c.download === "open" && !M() ? a.open() : a.getBuffer(function(a) { a = new Blob([a], { type: "application/pdf" });
                p(a, x(c)) })
        },
        title: "*",
        filename: "*",
